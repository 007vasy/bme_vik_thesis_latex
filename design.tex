...
%----------------------------------------------------------------------------			
			...
			The human mind can effortlessly interpret large amount of data with correct visual representation. Furthermore, can check the connections and facts derived from experts' knowledge\footnote{Not to mention, amend that knowledge.}. 
%----------------------------------------------------------------------------		
...
%----------------------------------------------------------------------------
		...
		\paragraph\noindent
		From previously generated files the nodes and edges, the two vital components of the graph can be generated. The nodes list should contains all the distinct warning and exchange part ID-s, the edges list should contain the timestamp, the from and to node's ID , and the vehicle ID.
%----------------------------------------------------------------------------
...
%----------------------------------------------------------------------------
			\subparagraph{Visualization}
			The human mind can easy interpret large amount of data with correct visual representation and to go further checked the connections and facts derived from experts' knowledge.\footnote{Not to mention, amend that knowledge.}
%----------------------------------------------------------------------------
		\subsubsection{Calculating RUL}
%----------------------------------------------------------------------------
