...
\begin{itemize}
			...
			\begin{itemize}
				\item{s_errorcode}
				\item{vehicle_serialnumber}
				\item{error_occurred_timestamp}
			\end{itemize}
...
%----------------------------------------------------------------------------		
		\paragraph{Visualization}
		The visualizations are beneficial when it comes to a graph represented data. In this project i had used a the NetworkX build in functions and the matplotlib package plotting functions.
